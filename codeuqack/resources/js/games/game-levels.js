 ...
 */
export async function initLevelSelect(course, gameTitle, onLevelStart) {
    ...
    onAuthStateChanged(auth, async (user) => {
      ...
      lessons.forEach((lesson, index) => {
        ...
        card.innerHTML = `
          ...
          <p class="font-bold text-deepChocolate text-sm leading-tight">${lesson.title}</p>
          <p class="text-xs mt-1 ${canPlay ? "text-warmOrange font-semibold" : "text-gray-400"}">
